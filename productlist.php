...
<head>
  <title>Underground | Your Products</title>
...
<body>
  ...
  <div class="position-absolute w-100">
    <div class="tab-content">
      <div class="tab-pane active text-white container p-5" id="home" role="tabpanel">
        <h1>Your Products</h1>
        <div class="tab-content" id="myTabContent">
                ...
                <?php
                    ...
                    if($count > 0){
                        while($row = mysqli_fetch_array($result)){
                            ...
                            echo "
                            <li class='list-group-item bg-dark p-5 border border-white mt-3 rounded'>
                              <div class='media'>
                                <img class='img-responsive w-25 align-self-center '
                                src='data:image/jpeg;base64,".base64_encode( $row['prodimg'] )."'
                                  alt='Kinder Surprise' />
                                <div class='media-body p-3'>
                                  <h5 class='mt-0'>".$row['pname']."</h5>
                                  <span id='pprice' class='text-success'>".$dprice." BTC</span> (<b id='dsct'>".$row['disctpct']."%</b> Off!)<br />
                                  <div class='dropdown position-absolute' style='top: 65%;'>
                                    <div class='btn-group'>
                                      <button type='btn btn-sm' class='btn btn-secondary dropdown-toggle' data-toggle='dropdown'
                                        aria-haspopup='true' aria-expanded='false'>
                                        More...
                                      </button>
                                      <div class='dropdown-menu'>
                                        <a class='dropdown-item' href='update.php?pid=".$row['pid']."&cat=".$row['cat']."'>Edit</a>
                                        <a class='dropdown-item' href='delete.php?pid=".$row['pid']."&cat=".$row['cat']."'>Delete</a>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                        ...
                        echo "
                        <li class='list-group-item bg-dark p-3 border border-white'>
                          <div class='media'>
                            <div class='media-body p-3'>
                              <h1 class='mt-0 text-center'>You didn't sell any products</h1>
                            </div>
                        </li>";
                    }
                ?>
          ...
          <div class="p-3 float-right">
            <a type="button" class="btn btn-logo btn-lg" href="sell.php">Add Product <i class="fa fa-plus"></i>
            </a>
          </div>
        </div>
      </div>
