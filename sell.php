...
<head>
  <title>Underground | Sell Product</title>
          ...
          <form method="POST" action="add.php" role="form" enctype="multipart/form-data">
            <div class="form-group">
              <div class="form-md input-group mt-5 mb-4">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="prodName"> </span>
                </div>
                <input type="text" id="productName" name="npname" class="form-control form-control-md validate"
            ...
            <div class="form-group">
              <div class="form-md input-group mb-4">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="pQ"><i class="fa fa-question-circle-o prefix"></i></span>
                </div>
                <input type="text" id="why" name="nwhy" class="form-control form-control-md validate rounded-right"
                  placeholder="Why are you selling the product here?" />
              </div>
            </div>
            <hr class="text-white bg-white" />
            <div class="form-group">
            ...
            <hr class="text-white bg-white" />
            <div class="form-row">
              <div class="col-md-6 mb-4 input-group">
                <div class="input-group-prepend">
                  <label class="input-group-text" for="condition"><i class="fa fa-cog"></i></label>
                </div>
                <select class="custom-select" id="condition" name="ncon">
              ...
              <div class="col-md-6 mb-4 input-group">
                <div class="input-group-prepend">
                  <label class="input-group-text" for="selectCategory"><i class="fa fa-bars"></i></label>
                </div>
            ...
            <div class="form-row">
              <div class="col-md-4 mb-4 input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="pStock"><i class="fa fa-database prefix"></i></span>
                </div>
                <input type="number" name="nstock" id="stock" class="form-control form-control-md validate rounded-right"
                  placeholder="Stock Quantity" min="0" />
              </div>
              <div class="col-md-4 mb-4 input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="pPrice"><i class="fa fa-btc prefix"></i></span>
                </div>
                <input type="number" id="pprice" name="nprice" class="form-control form-control-md validate rounded-right"
                  placeholder="Price (Bitcoin)" min="0" max="100" step="0.01" />
              </div>
              <div class="col-md-4 mb-4 input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="pDsct"><i class="fa fa-percent prefix"></i></span>
                </div>
                <input type="number" id="dsct" name="ndsct" class="form-control form-control-md validate rounded-right"
                  placeholder="Discount Percent" min="0" max="100" value="0" />
              </div>
            </div>
            <div class="form-row">
            ...
            <div id="hitmen" class="cfield">
              <hr class="text-white bg-white" />
              <div class="form-group">
                <div class="form-md input-group mb-4">
                  <div class="input-group-prepend">
                    <span class="input-group-text" id="hName"><i class="fa fa-user-circle-o prefix"></i></span>
                  </div>
                  <input type="text" id="hitName" class="form-control form-control-md validate rounded-right"
                    placeholder="Name of Hitman" name="nhname"/>
                </div>
              </div>
              <div class="form-group">
                <div class="md-form form-md input-group mb-4">
                  <div class="input-group-prepend">
                    <span class="input-group-text" id="hEmail"><i class="fa fa-envelope prefix"></i></span>
                  </div>
                  <input type="email" id="hitEmail" class="form-control form-control-md validate"
                    placeholder="Hitman's Email Address" name="nhemail" />
                </div>
              </div>
              <div class="form-row">
                <div class="col-md-4 mb-4 input-group">
                  <div class="input-group-prepend">
                    <label class="input-group-text" for="gender"><i class="fa fa-user"></i></label>
                  </div>
                  <select class="custom-select" id="gender" name="nhg">
                ...
                <div class="col-md-4 mb-4 input-group">
                  <div class="input-group-prepend">
                    <label class="input-group-text" for="request"><i class="fa fa-question"></i></label>
                  </div>
                  <select class="custom-select" id="request" name="nhr">
                    <option selected>What is their job type?</option>
                    <option value="Assassin">Assassin</option>
                    <option value="Bodyguard">Bodyguard</option>
                    <option value="Fetch/Robber">Fetch/Robber</option>
                ...
                <div class="col-md-4 mb-4 input-group">
                  <div class="input-group-prepend">
                    <label class="input-group-text" for="hrate"><i class="fa fa-fax"></i></label>
                  </div>
                  <select class="custom-select" id="hrate" name="nhrate">
                    <option selected>Rate Your Hitman</option>
            ...
            <div id="substances" class="cfield">
              <hr class="text-white bg-white" />
              ...
              <div class="form-row">
                <div class="col-md-4 mb-4 input-group">
                  ...
                  <select class="custom-select" id="grade" class="form-control form-control-md validate rounded-right"
                    placeholder="Substance Rate" name="nsgrade">
                    <option selected>Substance Grade</option>
                ...
                <div class="col-md-4 mb-4 input-group">
                  <div class="input-group-prepend">
                    <span class="input-group-text" id="sGrams"><i class="fa fa-cubes prefix"></i></span>
                  </div>
                  <input type="number" id="sgrams"  name="nsgrams"class="form-control form-control-md validate rounded-right"
                    placeholder="Weight (Grams)" min="0" step="0.01" />
                </div>
                <div class="col-md-4 mb-4 input-group">
                  <div class="input-group-prepend">
                  ...
                  <select class="custom-select" id="subtypes" name="nstype">
                    ...
                    <option value="Other Drugs">Other Drugs</option>
                  </select>
                </div>
              </div>
            </div>
            <div id="exotics" class="cfield">
              <hr class="text-white bg-white" />
              <div class="form-group">
                <div class="form-md input-group mb-4">
                  <div class="input-group-prepend">
                    <span class="input-group-text" id="exoType"><i class="fa fa-gift prefix"></i></span>
                  </div>
                  <select class="custom-select" id="exotypes" name="netype">
              ...
              <div class="form-group">
                <div class="form-md input-group mb-4">
                  <div class="input-group-prepend">
                    <span class="input-group-text" id="proTypes"><i class="fa fa-diamond prefix"></i></span>
                  </div>
                  <input type="text" id="protypes" class="form-control form-control-md validate rounded-right"
                    placeholder="Add Product Types" />
                  <div class="input-group-append">
                    <button class="btn btn-logo" type="button" id="addprod">Add</button>
                  </div>
                </div>
                <h4 class="text-logored">Product Types</h4>
                <div class="form-md input-group mb-4">
                  <select class="custom-select noselect" name="ptype[]" id="ptype" multiple readonly
                    data-selected-text-format="count > 1" tabindex="1">
                    <!--For php, use this to extract data:
                      foreach ($_GET['ptype'] as $selectedOption)
                      {
                        //get stuff from $selectedOption
                      }
                    -->
                  </select>
                </div>
            ...
            <div id="weapons" class="cfield">
              <hr class="text-white bg-white" />
              <div class="form-group">
                <div class="form-md input-group mb-4">
                  <div class="input-group-prepend">
                    <span class="input-group-text" id="wTypes"><i class="fa fa-exclamation-triangle prefix"></i></span>
                  </div>
                  <select class="custom-select" id="wtypes" name="nwtype">
                    <option selected>Choose Weapon Type</option>
                    <option value="F">Firearms/Ranged</option>
                    <option value="E">Explosives</option>
                    <option value="M">Melee</option>
                    <option value="C">Chemical/Biological/Nuclear</option>
                    <option value="U">Miscellenous</option>
                  </select>
                </div>
              </div>
            </div>
        ...
        <table class="table table-bordered table-hover table-sm table-condensed bg-white">
          <thead>
            <tr>
              ...
              <th title="Field #5">First Name</th>
              <th title="Field #6">Last Name</th>
            </tr>
          </thead>
          <tbody>
          <?php
